...
PARAM  <- list()
PARAM$experimento <- "TS9320_C4_exp1"

PARAM$exp_input  <- "FE9250_C4_exp1"

PARAM$future       <- c(  202109 )

PARAM$final_train  <- c(201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912, 202001, 202002, 20203, 202004, 202005, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105, 202106, 202107)

PARAM$train$training  <- c(201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912, 202001, 202002, 20203, 202004, 202005, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105)
...
PARAM$train$semilla_sampling  <- 732497 # robadas de forma descarada a agustin, porque creo en los scripts pero el azar existe
