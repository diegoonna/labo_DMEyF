...
PARAM$final_train  <- c(202007, 202008, 202009, 202103, 202104, 202105 ) # N = 6 meses

PARAM$train$training     <- c(202004, 202005, 202007, 202101, 202102, 202103 ) # N = 6 meses
