...
PARAM  <- list()
PARAM$experimento <- "TS9320_C4_exp2_modelo2"

PARAM$exp_input  <- "FE9250_C4_exp1"

PARAM$future       <- c(  202109 )

PARAM$final_train  <- c(201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912, 202101, 202102, 202103, 202104, 202105, 202106, 202107)

PARAM$train$training  <- c(201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912, 202101, 202102, 202103, 202104, 202105)
